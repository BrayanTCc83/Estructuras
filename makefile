...
run: $(MAIN) $(STATIC_QUEUE) $(STATIC_STACK) $(STATIC_LIST) $(STATIC_SET) $(GLOBAL) $(HEADERS)/*.h | $(DISTRIBUTION)
	@echo Compile program.
	$(CC) -o $(OUTPUT) $(MAIN) $(STATIC_QUEUE) $(STATIC_STACK) $(STATIC_LIST) $(STATIC_SET) $(GLOBAL) -I $(HEADERS) -DDEV
