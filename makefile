...
run: $(MAIN) $(STATIC_QUEUE) $(STATIC_STACK) $(STATIC_LIST) $(STATIC_SET) $(GLOBAL) $(STACK) $(HEADERS)/*.h | $(DISTRIBUTION)
	@echo Compile program.
	$(CC) -o $(OUTPUT) $(MAIN) $(STATIC_QUEUE) $(STATIC_STACK) $(STATIC_LIST) $(STATIC_SET) $(GLOBAL) $(STACK) -I $(HEADERS) -DDEV
